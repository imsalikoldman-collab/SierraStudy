...
| `
| `PipeMonitor.ps1` | Подключается к именованному каналу и печатает JSON, отправляемый мостом (для отладки без MT5). | -PipeName, -MaxMessages.
...
| BuildSolution.ps1 | ������ ����: MSBuild (Wrapper+Bridge), Google Test, ���������� MT5-��������� � ��������� �����. | -Configuration, -Platform, -SkipTests, -TestFilter, -SkipAdvisor, -MetaEditorPath, -Mt5DataDir, -AdvisorSource, -AdvisorOutputDir. |
...
# ������ ������ Release + MT5-�������� � �����
pwsh -File scripts\BuildSolution.ps1 -Configuration Release -Mt5DataDir "C:\SierraChart\Data"
...
2. `Analysis → Add Custom Study → Add Custom Study → Browse` и выберите `C:\2308\Data\SierraStudyMT5.dll`. После этого исследование появится как `SierraStudy - Moving Average`.
