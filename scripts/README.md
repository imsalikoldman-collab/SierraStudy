...
2. `Analysis → Add Custom Study → Add Custom Study → Browse` и выберите `C:\2308\Data\SierraStudy_Spotgamma.dll`. После этого исследование появится как `SierraStudy - Moving Average`.
